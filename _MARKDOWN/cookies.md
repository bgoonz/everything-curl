...
</span> #define SEP "\t" /_ Tab separates the fields _/​char _my_cookie = "example.com" /_ Hostname _/ SEP "FALSE" /_ Include subdomains _/ SEP "/" /_ Path _/ SEP "FALSE" /_ Secure _/ SEP "0" /_ Expiry in epoch time format. 0 == Session _/ SEP "foo" /_ Name _/ SEP "bar"; /_ Value \*/​curl_easy_setopt(curl, CURLOPT_COOKIELIST, my_cookie);<span class="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1">
